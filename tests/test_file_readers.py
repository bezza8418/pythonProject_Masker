...
class TestFileReaders:
    ...
    def test_read_csv_file_permission_error(self, monkeypatch):
    ...
    def test_read_csv_file_empty_data_error(self, monkeypatch):
        """Тест ошибки EmptyDataError при чтении CSV."""
    ...
    def test_read_csv_file_parser_error(self, monkeypatch):
        """Тест ошибки ParserError при чтении CSV."""
    ...
    def test_read_csv_file_unicode_error(self, monkeypatch):
        """Тест ошибки UnicodeDecodeError при чтении CSV."""
    ...
    def test_read_excel_file_permission_error(self, monkeypatch):
        """Тест ошибки доступа к Excel-файлу."""

        def mock_read_excel(*_args, **_kwargs):
            raise PermissionError("Permission denied")
    ...
    def test_read_excel_file_value_error(self, monkeypatch):
        """Тест ошибки ValueError при чтении Excel."""
    ...
    def test_read_excel_file_import_error(self, monkeypatch):
        """Тест ошибки ImportError при чтении Excel."""
